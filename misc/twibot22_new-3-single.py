...
if __name__ == "__main__":
    ...
    tweet_data_paths = '/cs/student/projects1/sec/2023/jmoussa/twibot22/tweet_test/tweet_*.json'
    output_path = 'output/preprocessed_twibot22_1_2_single.csv'  # Replace with the desired output path
